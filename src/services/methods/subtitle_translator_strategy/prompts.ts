...
۱. رعایت اجباری نیم‌فاصله واقعی (U+200C):
   - افعال مضارع و ماضی استمراری: می‌روم، نمی‌دانم، می‌خواهم، نمی‌توانست، می‌بینم، می‌گویند
...
۲. ممنوعیت کامل: هرگز به جای نیم‌فاصله از فاصله معمولی («می روم»)، خط تیره («می-روم») یا چسباندن («بهینهتر») استفاده نکنید.
۳. علائم نگارشی فارسی: چسبیده به کلمه قبل با یک فاصله بعد (مانند: «سلام، حالت چطور است؟»). استفاده از «ی» و «ک» استاندارد فارسی.`;
