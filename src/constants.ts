...
2. قواعد نیم‌فاصله (ZWNJ): استفاده از نیم‌فاصله واقعی (U+200C) در افعال (می‌روم، نرفته‌ام)، نشانه‌های جمع (کتاب‌ها)، و واژگان مرکب (بهینه‌سازی) قطعی و الزامی است. استفاده از فاصله معمولی (Space)، خط تیره (-) یا تطویل (Tatweel) به جای نیم‌فاصله اکیداً ممنوع است.
...
• نیم‌فاصله الزامی و قطعی (ZWNJ): استفاده از نیم‌فاصله در افعال (می‌روم، نرفته‌ام)، نشانه‌های جمع (کتاب‌ها)، واژگان ترکیبی (بهینه‌سازی، برنامه‌نویسی) و پیشوندها/پسوندهای پیوسته کاملاً اجباری است.
• ممنوعیت‌ها: جایگزینی نیم‌فاصله با فاصله معمولی (Space)، خط تیره (-) یا کشیدگی (Tatweel) مطلقاً ممنوع است.
