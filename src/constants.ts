...
2. قواعد هوشمندانه نیم‌فاصله (ZWNJ): استفاده از نیم‌فاصله واقعی (U+200C) در افعال استاندارد (می‌روم، نرفته‌ام)، نشانه‌های جمع (کتاب‌ها)، و واژگان مرکب (بهینه‌سازی، فارسی‌زبان) قطعی و الزامی است.
   * هشدار بسیار مهم (DO NOT OVER-APPLY): از افزودن مکانیکی و اشتباه نیم‌فاصله در افعال و واژگان رایج محاوره‌ای و ساختارهای پیوسته اکیداً خودداری کنید. واژگانی مانند «میدن»، «نمیدن»، «نمیشه»، و «میزان» باید کاملاً پیوسته (بدون هیچ فاصله‌ای) نوشته شوند. قضاوت نگارشی حرفه‌ای (مطابق فرهنگستان زبان) بر استفاده چشم‌بسته از نیم‌فاصله ارجحیت دارد.
...
Priority 5: Conceptual Precision. For technical/educational topics, maintain rigorous accuracy and authoritative terminology.`;
  ...
  const persianRules = isPersian
    ? `--- الزامات نگارش و ویرایش فارسی (CRITICAL ORTHOGRAPHY) ---
• نیم‌فاصله الزامی و قطعی (ZWNJ): استفاده از نیم‌فاصله در افعال استاندارد (می‌روم، نرفته‌ام)، نشانه‌های جمع (کتاب‌ها)، واژگان ترکیبی (بهینه‌سازی، برنامه‌نویسی) و پیشوندها/پسوندهای پیوسته کاملاً اجباری است.
• ممنوعیت درج نیم‌فاصله اشتباه (DO NOT OVER-APPLY): افزودن مکانیکی نیم‌فاصله به واژگان محاوره‌ای و پیوسته اکیداً ممنوع است. افعال و کلماتی نظیر «میدن»، «نمیدن»، «نمیشه»، «میزان» و موارد مشابه باید کاملاً سرهم و بدون هیچ فاصله‌ای نوشته شوند.
